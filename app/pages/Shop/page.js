...
const Shoppage = () => {
  ...
  const handleCardClick = () => {
    router.push('/pages/Shop/SelectShop');
  };

  const collections = [
    {
      id: 1,
      image: "/image/shop-1.jpg",
      title: "Pet Care Shop",
      oldPrice:'$6000',
      nexPrice:'$5000',
